$(document).ready(function() {
	// NAVBAR
		$('.menu-trigger').click(function() {
			...
			$(this).fadeTo(100, 0.5, function() {
				$(this).toggleClass('active toggleMenu');
			});
		});
	...
	// HTML CLASS
		...
		// Browser
		if (isBrowserOs.Chrome()) html_class += ' chrome';
		if (isBrowserOs.Firefox()) html_class += ' firefox';
		if (isBrowserOs.IE()) html_class += ' ie';
		if (isBrowserOs.Opera()) html_class += ' opera';
		if (isBrowserOs.SeaMonkey()) html_class += ' seamonkey';
		if (isBrowserOs.Camino()) html_class += ' camino';
		if (isBrowserOs.Safari()) html_class += ' safari';
